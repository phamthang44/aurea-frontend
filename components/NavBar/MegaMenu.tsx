                ...
                <AnimatePresence>
                  {isHovered && (
                    <motion.div
                      ...
                      className="absolute top-full left-0 mt-2 w-[600px] bg-white/95 dark:bg-[#262622]/98 backdrop-blur-xl border border-[#D4AF37]/30 dark:border-[#3D3D3D] rounded-lg shadow-2xl p-8 z-50"
                      onMouseEnter={() => setHoveredItem(item.label)}
                      onMouseLeave={() => setHoveredItem(null)}
                    >
