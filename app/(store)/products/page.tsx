...
import { useProductStorefrontOptimized } from "@/hooks/shop/useProductStorefrontOptimized";
...
function ShopPageContent() {
  ...
  // Use optimized hook that fetches products + categories in a single BFF call
  const {
    products,
    categories, // Categories now come from the same BFF call - no extra request!
    isLoading,
    error,
    filters,
    setFilter,
  ...
  // Categories are now directly from the hook (no separate query needed!)
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {/* Main Content */}
      <div className="container mx-auto px-4 py-8 flex-1 mt-28">
