...
const statusConfig: Record<OrderStatus, { label: string; className: string }> =
  {
    PENDING: {
      label: "Pending",
      className:
        "bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-700/50",
    },
    CONFIRMED: {
      label: "Confirmed",
      className:
    ...
    SHIPPING: {
      label: "Shipping",
      className:
        "bg-indigo-100 text-indigo-800 border-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-400 dark:border-indigo-700/50",
    },
    COMPLETED: {
      label: "Completed",
      className:
        "bg-emerald-100 text-emerald-800 border-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400 dark:border-emerald-700/50",
    },
    CANCELLED: {
      label: "Cancelled",
      className:
...
export function OrderStatusBadge({
  ...
  const normalizedStatus = (status?.toUpperCase() || "PENDING") as OrderStatus;
